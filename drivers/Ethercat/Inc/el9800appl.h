...
/** \brief 0x7011 (Analog output object) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT32   DAoutput; /**< \brief SubIndex 0*/
...
OBJCONST TSDOINFOENTRYDESC	OBJMEM asEntryDesc0x1601[] = {
   {DEFTYPE_UNSIGNED8, 0x9, ACCESS_READ },
   ...
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ}//-----WSY
   };
...
#ifdef _EVALBOARD_
 = {10, {0x70100101, 0x70100201, 0x70100301, 0x70100401,0x70100501, 
      0x70100601, 0x70100701, 0x70100801, 0x08, 0x70110020}}
#endif
;
/** @}*/
...
/**
 * \brief 0x7011 (Var0x7011  output object) variable to handle object data
 * 
 */
...
/**
 * \brief Object 0x8021 (Var0x8021 output settings) entry descriptions
 *
 */
#ifdef _OBJD_
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x8021 
=  { DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READWRITE | OBJACCESS_BACKUP | OBJACCESS_SETTINGS};

/** \brief Object 0x8020 (Analog input settings) object and entry names*/
OBJCONST UCHAR OBJMEM aName0x8021[] = "Var0x8021 output  000\377";
#endif //#ifdef _OBJD_
...
#endif
;
/** \brief Object 0x8021 (var0x8021 output settings) variable*/
PROTO UINT32 Var0x8021
#ifdef _EVALBOARD_
= 0x00
#endif
;
...
TOBJECT    OBJMEM ApplicationObjDic[] = {
   ...
   //{NULL,NULL,   0x7011, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, sEntryDesc0x7011, aName0x7011, &Var0x7011, NULL, NULL, 0x0000 },
    /* Object 0x8020 */// SDO
    {NULL,NULL,   0x8020, {DEFTYPE_RECORD, 20 | (OBJCODE_REC << 8)}, asEntryDesc0x8020, aName0x8020, &sAISettings, NULL, NULL, 0x0008 },
    /* Object 0x8020 */// SDO
    {NULL,NULL,   0x8021, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x8021, aName0x8021, &Var0x8021, NULL, NULL, 0x0008 },
    /* Object 0xF000 */
