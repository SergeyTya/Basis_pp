/**
\addtogroup SSC-Device2 SSC-Device2
@{
*/
...
void APPL_InputMapping(UINT16* pData)
{
   ...
   // #warning "Implement input (Slave -> Master) mapping"
    ...
    for (j = 0; j < sTxPDOassign.u16SubIndex0; j++)
    {
      ...
      /* TxPDO 1 */
      case 0x1A00:
        *pTmpData++ = SWAPWORD(((UINT16 *) &SlaveData0x6000)[1]);
       // *pTmpData++ = SWAPWORD(SlaveData0x6000.I_A);
        break;
      }
   }
...
void APPL_OutputMapping(UINT16* pData)
{
  ...
  //  #warning "Implement output (Master -> Slave) mapping"
    ...
    for (j = 0; j < sRxPDOassign.u16SubIndex0; j++)
    {
        ...
        /* RxPDO 2 */
        case 0x1600:
            ((UINT16 *) &ControlUnit0x7000)[1] = SWAPWORD(*pTmpData++);
            break;
        }
    }
    LED_3 = ~LED_3;
...
void APPL_Application(void)
{
   ...
   // #warning "Implement the slave application"
    ...
    SlaveData0x6000.I_A = uhADCxConvertedValue;
