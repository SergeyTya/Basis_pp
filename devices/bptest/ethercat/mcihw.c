...
------
--------------------------------------------------------------------------------------*/
#define    ECAT_TIMER_ACK_INT             TIM_ClearITPendingBit(TIM3 , TIM_FLAG_Update)//clear interrupt flag
#define    HW_EcatIsr                     EXTI0_IRQHandler/*Irq interrupt service function*/
#define    APPL_1MsTimerIsr               TIM3_IRQHandler/*Interrupt service function of millisecond timer*/
...
#define    Sync0Isr                       EXTI3_IRQHandler//SYNC0 interrupt function
#define    DISABLE_SYNC0_INT              NVIC_DisableIRQ(EXTI3_IRQn)	// disable SYNC0 interrupt 
#define    ENABLE_SYNC0_INT               NVIC_EnableIRQ(EXTI3_IRQn)	// enable SYNC0 interrupt
#define    ACK_SYNC0_INT                  EXTI_ClearITPendingBit(EXTI_Line3)//  {(SYNC0_INT_REQ) = 0;}
...
#define    DISABLE_SYNC1_INT              NVIC_DisableIRQ(EXTI1_IRQn)// disable SYNC1 interrupt 
#define    ENABLE_SYNC1_INT               NVIC_EnableIRQ(EXTI1_IRQn)  // enable SYNC1 interrupt 
#define    ACK_SYNC1_INT                  EXTI_ClearITPendingBit(EXTI_Line1)// ����жϱ�־
