 ...
 */
#define HW_GetTimer()		TIMER_CNT(TIMER2)
#endif
 ...
 */
#define HW_ClearTimer() 	TIMER_CNT(TIMER2) = 0
#endif

#define    INIT_ESC_INT           	  EXTI0_Configuration()	/*IRQ interrupt init*/

#define    DISABLE_ESC_INT()         set_escint_state(0) 
// NVIC_DisableIRQ(EXTI0_IRQn)/* disable IRQ interrupt*/	/**< \brief Disable interrupt source INT1*/

#define    ENABLE_ESC_INT()          set_escint_state(1)
//  NVIC_EnableIRQ(EXTI0_IRQn) /* enable IRQ interrupt*//**< \brief Enable interrupt source INT1*/
 ...
 */
#define ECAT_TIMER_INC_P_MS    100
